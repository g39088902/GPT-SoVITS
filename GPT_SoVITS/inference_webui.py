...
cache= {}
def get_tts_wav(ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut=i18n("按中文句号。切"), top_k=20, top_p=1, temperature=1, ref_free = False,speed=1,if_freeze=False,inp_refs=[]):
    global cache
